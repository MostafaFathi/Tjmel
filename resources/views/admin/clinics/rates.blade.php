<div class="row pt-3">
    <div class="col-12 text-center ">
        ...
        <div class="form-group">
            <label class="control-label font-weight-bold" for="name">Total Rating : </label>
                ...
                <td>
                    ...
                    <div class="dropdown-menu dropdown-menu-lg">
                        <a class="dropdown-item" data-placement="top" title="Delete" href="javascript:void(0)"
                           ...
                           data-target="#delete_item_modal_rate"><i class="icon-cross3"></i>Delete</a>
                    </div>
                </td>
        ...
        <div class="modal-content">
            <form id="delete_form_rate" method="post" action="">
                ...
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Delete Rate <span id="del_label_title"></span>
                    </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <h4>Confirm Delete Rate</h4>
                    <p id="grup_title"></p>
