    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><span class="font-weight-semibold">تعديل تفاصيل العرض </span></h4>
            ...
            <div class="card-body">
                ...
                <form class="rated" action="{{route('admin.offers.update',$offer->id)}}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  id="clinic_name_ar"
                                       name="name_ar"
                                       value="{{$offer->name_ar}}">
                            </div>
                            <div class="form-group">
                                ...
                                <select name="section_id" required id="section_id" class="form-control"
                                    ...
                                    @foreach($sections as $section)
                                        <option
                                            value="{{$section->id}}" {{$section->id == $offer->section->id ? 'selected' : ''}}>{{$section->title_ar}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="name">السعر قبل</label>
                                <input  type="text" class="form-control" id="price_before" name="price_before"
                    ...
                    <div class="form-group" style="text-align: left;">
                        ...
                        <button class="btn btn-success"  name="save_type" value="save_only">حفظ التغييرات</button>
                    </div>
                </form>
            </div>
        </div>
