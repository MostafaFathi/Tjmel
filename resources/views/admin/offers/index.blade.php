            ...
            <div class="form-row">
                ...
                <div class="input-group col-3 mb-md-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="addon-wrapping">اسم العرض</span>
                    </div>
                    <input type="text" class="form-control" autocomplete="chrome-off" name="offer_name"
                           value="{{request()->get('offer_name')}}"
                    ...
                    <div class="card card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="input-group col-4 mb-md-4">
                                ...
                                <select name="offer_status" class="form-control" id="">
                                    <option value="100" {{request()->has('offer_status') && request()->get('offer_status') == 100 ? 'selected' : ''}}>إختر</option>
                                    <option value="0" {{request()->has('offer_status') && request()->get('offer_status') == 0 ? 'selected' : ''}}>قيد الانتظار</option>
                                    <option value="1" {{request()->has('offer_status') && request()->get('offer_status') == 1 ? 'selected' : ''}}>تم نشره</option>
                                    <option value="2" {{request()->has('offer_status') && request()->get('offer_status') == 2 ? 'selected' : ''}}>مرفوض</option>
                                </select>
                            </div>
                            <div class="input-group col-4 mb-md-4">
                                <div class="input-group-prepend">
                ...
                <table class="table">
                    ...
                    @foreach($offers as $offer)
                        ...
                        <tr @if(session('id') === $offer->id)class="bg-green" @endif>
                            ...
                            <td>
                                <div style="text-decoration: line-through;color: #9E9E9E;">قبل
                                    الخصم:{{$offer->price_before ?? '--'}}</div>
                            ...
                            <td>
                                ...
                                <div class="dropdown-menu dropdown-menu-lg">
                                    ...
                                    <a class="dropdown-item" data-placement="top"
                                       title="{{$offer->status == 0 or $offer->status == 2 ? 'موافقة ونشر' : 'رفض واخفاء'}}"
                                       href="javascript:void(0)"
                                       onclick="approve_item('{{$offer->id}}','{{$offer->name}}')" data-toggle="modal"
                                       data-target="#approve_item_modal"><i
                                            class="{{$offer->status == 0 || $offer->status == 2 ? 'icon-check2' : 'icon-blocked'}} "></i>{{$offer->status == 0 || $offer->status == 2 ? 'موافقة ونشر' : 'رفض واخفاء'}}
                                    </a>
                ...
                <div class="modal-content">
                    <form id="delete_form_delete" method="post" action="">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel">حذف العرض <span
                                    id="del_label_title_delete"></span>
                            </h4>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-danger waves-effect" id="delete_ur_deletel">حذف
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="delete_form" method="post" action="">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel">موافقة/رفض العرض <span
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-info waves-effect" data-dismiss="modal">اغلاق</button>
                            <button type="submit" class="btn btn-success waves-effect" id="delete_url">حفظ الحالة
                                الجديدة
                            </button>
                        </div>
                    </form>
