    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><span class="font-weight-semibold">عرض تفاصيل القسم </span></h4>
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="rated" action="{{route('sections.update',$section->id)}}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title_ar" disabled name="title_ar" value="{{$section->title_ar}}">
                            </div>
...
@section('js_code')
    ...
    <script>
        ...
        options['initialPreviewConfig'] =  [
            {caption: 'Image',  key: 1, url: '{{$section->image}}', showDrag: false},
        ];
        @endisset
