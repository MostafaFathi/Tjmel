    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><span class="font-weight-semibold">Section</span></h4>
            </div>
            <div class="header-elements">
                <a type="button" class="btn btn-primary" href="{{route('sections.create')}}">Create</a>
            </div>
                        ...
                        <tr @if(session('id') === $section->id)class="bg-green" @endif>
                            ...
                            <td>
                                ...
                                <a class="dropdown-item" data-toggle="tooltip" data-placement="top" title="Edit"
                                   href="{{route('sections.edit',$section->id)}}"><i class="icon-pencil7"></i>Edit</a>
