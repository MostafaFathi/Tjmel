    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">تفاصيل التلميح</h5>
            ...
            <div class="card-body">
                ...
                <form class="rated" action="{{route('tips.update',$tip->id)}}" method="post"
...
@section('js_code')
    <script>
        ...
        @isset($tip->image)
            ...
            '{{FileStorage::getUrl($tip->image)}}',
        ];
        options['initialPreviewConfig'] =  [
            {caption: 'Image',  key: 1, url: '{{FileStorage::getUrl($tip->image)}}', showDrag: false},
        ];
        @endisset
