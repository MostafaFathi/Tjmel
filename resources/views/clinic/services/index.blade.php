                ...
                @endif
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <th colspan="6" class="text-center font-weight-bold" style="font-size: 22px;    color: #969696;">إدارة الخدمات التي تقدمها العيادة</th>
                            </tr>
...
@section('js_code')
    <script>
        function delete_item(id, title) {
            ...
            var url = "<?php echo e(url('clinic/services/delete')); ?>/" + id;
